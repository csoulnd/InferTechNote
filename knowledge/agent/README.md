...
2. Core concepts and mechanisms: [AGI](concepts/agi.md), [Agent Loop](concepts/agent-loop.md), [ReAct](concepts/react.md), [Agent Hint](concepts/agent-hints.md), [Agent Hint serving optimization](concepts/agent-hint-serving-optimization.md), [Manifest](concepts/manifest.md), [Hook](concepts/hook-mechanism.md), and [Cordis](concepts/cordis-plugin-runtime.md)

...
2. Agent 专题周：至少完成 1 篇 [notes/](study-notes/README.md)
3. 基础设施周：只读 01 介绍文档，点开 1–2 个 P0 链接即可

## 推荐技术栈学习顺序

（与 [01-infrastructure/README](../knowledge/agent/concepts/infrastructure/README.md) 一致）
...
延伸阅读见 [01-infrastructure/README](../knowledge/agent/concepts/infrastructure/README.md) Capstone 章节。
